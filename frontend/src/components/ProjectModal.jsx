...
import { X, ExternalLink, Github, Layers, Code, CheckCircle, ChevronRight } from 'lucide-react';
                ...
                <div className="space-y-4">
                  {project.details.role && (
                    <div>
                      ...
                      <p className="font-medium text-gray-900 dark:text-white">{project.details.role}</p>
                    </div>
                  )}
                   {project.details.outcomes && (
                    <div>
                      <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-1">Impact</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-300">{project.details.outcomes}</p>
                    </div>
                  )}
                </div>
              )}
